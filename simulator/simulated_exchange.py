...
from simulator.base_engine import TradeOrder, TradeResult
...
class SimulatedExchangeBase(StockExchange):
    ...
    def sell(self, date: datetime, price: float, shares: Optional[int] = None) -> TradeResult:
        sell_shares = shares if shares is not None else self.lot_size
